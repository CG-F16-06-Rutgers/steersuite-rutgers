...
public:
	...
	//Util::Vector velocity() const { throw Util::GenericException("velocity() not implemented yet"); } // TODO
	// He Chen
	Util::Vector velocity() const { return _velocity; } // TODO is it correct?
	// He Chen
