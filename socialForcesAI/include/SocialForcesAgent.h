...
// He Chen
#define MAX_QUEUE_AHEAD 1
#define MAX_QUEUE_RADIUS 1
#define WALL_OFFSET 2
#define WALL_TIME_INTERVAL 10
#define ALIGNMENT_DIS 2
#define ALIGNMENT_ANG 120
#define ALIGNMENT_WEIGHT 0.2
#define COHESION_DIS 2
#define COHESION_ANG 120
#define COHESION_WEIGHT 0.4
#define SEPARATION_DIS 2
#define SEPARATION_ANG 120
#define SEPARATION_WEIGHT 0.42
#define FLOCK_DIS 2
// He Chen
...
private:
	...
	// He Chen
	float _deadlockWeight;
	Util::Point wallFollower(float);
	SocialForcesAgent *NeighborAhead(void);
        Util::Vector calcQueueForces(Util::Vector, float);
        void printPoint(Util::Point);
        void printVector(Util::Vector);
        Util::Vector separationForces(float);
	void computePlan();
